...
async function main() {
    ...
    while(true) {
        ...
        try{
            switch(choice) {
            case '1':
                const fileName = readlineSync.question('Digite o nome do aquivo ')
            ...
            case '4':
                ...
                const newCotent = readlineSync.question("Digite o conteudo a ser escrito: ")
                const messageWrite = await fileManager.writeFile(writeFilePath, newCotent)
